...
SRC_URI = "\
    file://libarducam_pivariety.so.1.0.2 \
...
do_install () {
    ...
    install -m 644 ${WORKDIR}/libarducam_pivariety.so.1.0.2 ${D}${libdir}
    ...
    ln -sf libarducam_pivariety.so.1.0.2 ${D}${libdir}/libarducam_pivariety.so
}

FILES:${PN} = "${libdir}/libarducam_pivariety.so.1.0.2"
